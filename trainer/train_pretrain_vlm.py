...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Tiny-VLM Pretrain")
    ...
    parser.add_argument("--wandb_project", type=str, default="Tiny-VLM-Pretrain", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Tiny-VLM-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}"
        wandb.init(project=args.wandb_project, name=wandb_run_name, id=wandb_id, resume=resume)

    model, tokenizer, preprocess = init_vlm_model(
        vlm_config, from_weight=args.from_weight, device=args.device, freeze_llm=bool(args.freeze_llm)
    )
